...
<html>
  ...
  <body>
  <h1>Fatal and error messages logged for Vitomy-App in the last 5 days</h1>
  <table id="logTable">
      <tr>
	...
	<gvisualization:lineCoreChart elementId="errorChart" title="Error Events" width="${500}" height="${300}" columns="${appChartData.errCols}" data="${appChartData.errStats}" />
	<gvisualization:lineCoreChart elementId="fatalChart" title="Fatal Events" width="${500}" height="${300}" columns="${appChartData.fatalCols}" data="${appChartData.fatalStats}" />

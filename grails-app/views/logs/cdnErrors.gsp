...
<html>
  ...
  <body>
  <h1>Fatal and error messages logged for Vitomy-Cdn in the last 5 days</h1>
  <table id="logTable">
      <tr>
	...
	<gvisualization:lineCoreChart elementId="errorChart" title="Error Events" width="${500}" height="${300}" columns="${cdnChartData.errCols}" data="${cdnChartData.errStats}" />
	<gvisualization:lineCoreChart elementId="fatalChart" title="Fatal Events" width="${500}" height="${300}" columns="${cdnChartData.fatalCols}" data="${cdnChartData.fatalStats}" />
